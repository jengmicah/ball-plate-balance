package InternPackage
  ...
  model NewBallandPlate_2D_controlled
    ...
    Modelica.Blocks.Math.Gain gain(k = -1) annotation(Placement(visible = true, transformation(origin = {-100.184, 45.184}, extent = {{-5.184, -5.184}, {5.184, 5.184}}, rotation = 0)));
    ModelPlug.Boards.Arduino arduino(Port = "COM3") annotation(Placement(visible = true, transformation(origin = {-18.006, 5}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    ModelPlug.Pins.Servo servo1(Pin = 10) annotation(Placement(visible = true, transformation(origin = {-23.096, -85}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ModelPlug.Pins.Servo servo(Pin = 9) annotation(Placement(visible = true, transformation(origin = {-16.616, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Math.Gain gain1(k = -1) annotation(Placement(visible = true, transformation(origin = {-100.184, -90.184}, extent = {{-5.184, -5.184}, {5.184, 5.184}}, rotation = 0)));
  equation
    connect(Xin, gain1.u) annotation(Line(visible = true, origin = {-119.211, -75.092}, points = {{-32.418, 15.092}, {9.806, 15.092}, {9.806, -15.092}, {12.806, -15.092}}, color = {0, 0, 127}));
    connect(Zin, gain.u) annotation(Line(visible = true, origin = {-118.804, 35.092}, points = {{-31.196, -10.092}, {9.399, -10.092}, {9.399, 10.092}, {12.399, 10.092}}, color = {0, 0, 127}));
    connect(gain1.y, convertRange1.u) annotation(Line(visible = true, origin = {-77.12, -90.447}, points = {{-17.361, 0.263}, {4.12, 0.263}, {4.12, -0.263}, {9.12, -0.263}}, color = {0, 0, 127}));
    connect(gain.y, convertRange.u) annotation(Line(visible = true, origin = {-77.12, 43.004}, points = {{-17.361, 2.18}, {4.12, 2.18}, {4.12, -2.18}, {9.12, -2.18}}, color = {0, 0, 127}));
    connect(servo1.pinConnector, arduino.boardConnector) annotation(Line(visible = true, origin = {-13.855, -36.2}, points = {{0.759, -48.8}, {3.771, -48.8}, {3.771, 28.2}, {-4.151, 28.2}, {-4.151, 41.2}}));
    connect(convertRange1.y, servo1.u) annotation(Line(visible = true, origin = {-38.936, -88.886}, points = {{-11.495, -3.886}, {2.827, -3.886}, {2.827, 3.886}, {5.84, 3.886}}, color = {0, 0, 127}));
    connect(servo.pinConnector, arduino.boardConnector) annotation(Line(visible = true, origin = {-9.967, 24.2}, points = {{3.351, 15.8}, {6.363, 15.8}, {6.363, -6.2}, {-8.039, -6.2}, {-8.039, -19.2}}));
    connect(convertRange.y, servo.u) annotation(Line(visible = true, origin = {-34.076, 39.381}, points = {{-16.355, -0.619}, {4.447, -0.619}, {4.447, 0.619}, {7.46, 0.619}}, color = {0, 0, 127}));
    annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Rectangle(visible = true, fillColor = {0, 255, 0}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-90, -90}, {90, 90}}), Text(visible = true, origin = {2.263, 15.993}, extent = {{-79.658, -27.5}, {79.658, 27.5}}, textString = "Plate", textStyle = {TextStyle.Bold}), Text(visible = true, origin = {0, -32.071}, extent = {{-83.727, -32.071}, {83.727, 32.071}}, textString = "2D", textStyle = {TextStyle.Bold})}), experiment(StopTime = 10, __Wolfram_SynchronizeWithRealTime = false), Diagram(coordinateSystem(extent = {{-148.5, -105}, {148.5, 105}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})));
  end NewBallandPlate_2D_controlled;

  model Controlled_Plate_Model
    NewBallandPlate_2D_controlled Ball_Model(arduino.Port = "COM5") annotation(Placement(visible = true, transformation(origin = {32.012, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
