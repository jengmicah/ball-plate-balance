package Solver
  ...
  model BallBalance
    ...
    Modelica.Blocks.Interfaces.RealInput X annotation(Placement(visible = true, transformation(origin = {-85, -67.895}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-97.643, 23.81}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    ...
    hardware1 hardware1_1 annotation(Placement(visible = true, transformation(origin = {-65, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(hardware1_1.rightSensorValueInMeter, feedback.u2) annotation(Line(visible = true, origin = {-79.8, 0.078}, points = {{24.8, 19.922}, {27.8, 19.922}, {27.8, -14.948}, {-40.2, -14.948}, {-40.2, -9.948}}, color = {0, 0, 127}));
    connect(X, hardware1_1.u) annotation(Line(visible = true, origin = {-81.667, -14.174}, points = {{-3.333, -53.721}, {-3.333, 26.86}, {6.667, 26.86}}, color = {0, 0, 127}));
    connect(add.y, hardware1_1.servo_angle_input) annotation(Line(visible = true, origin = {-42, 54.416}, points = {{33, 23.714}, {36, 23.714}, {36, 10.702}, {-36, 10.702}, {-36, -34.416}, {-33, -34.416}}, color = {0, 0, 127}));
